...
def distance(angle_side, angle_lookahead, data, direction = 'right'):
	...
	# Calculate error
	# If the distance from the right wall is greater than the threshold then the error will be negative.
	# If the distance from the right wall is less than the threshold then the error will be positive.
